...
`perl ~user105/software/gene_annot_lzu_v2/utils/split_fasta.pl $genome split_genome no` if(! -e "split_genome");
...
`perl /data/00/user/user101/software/gene_annot_lzu_v2/utils/merge_LTRharvest.pl LTRharvest $name`;
